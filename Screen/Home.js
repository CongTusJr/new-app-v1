...
const Home = ({ navigation }) => {
  ...
  useEffect(() => {
      fetch('http://192.168.0.104:4000/api/getproducts') //chú ý đổi mạng của chính bản thân
      .then(data => {
        return data.json()
      })
      .then(data => {
      ...
      <Header
        ...
        rightComponent={
          <View style={styles.headerRight}>
            ...
            <TouchableOpacity style={styles.filterButton} onPress={() => navigation.navigate("CartDone")}>
